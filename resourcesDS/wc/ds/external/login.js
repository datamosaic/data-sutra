...
// variables named here actually defined in config/site.js...how to include through?
var dsDomain = 'http://servlets:8081';
var dsLoginDomain = 'http://localhost:8081';

// this function includes all necessary js files for the application
	//TODO: get this to load with enough time to run the subsequent functions
...
function dsLogin(path) {
	...
	var url = dsDomain + (path || '/ds/launchingDS');
...
function onMessage(messageEvent) {  
	...
	if (messageEvent.origin == dsDomain) {
...
window.onload = function() { 
	...
	windowProxy = new Porthole.WindowProxy(dsDomain + '/ds/external/proxy.html', 'ds_website');
