...
var SpinningWheel = {
	...
	create: function (top, left) {
		...
		div.id = 'sw-wrapper';
		div.style.top = top + 'px';		// Place the SW down the actual viewing screen
		div.style.left = left + 'px';		// Place the SW down the actual viewing screen
		div.style.webkitTransitionProperty = '-webkit-transform';
		div.innerHTML = '<div class="popover_triangle"></div><div id="sw-header"><div id="sw-cancel">Cancel</' + 'div><div id="sw-done">Done</' + 'div></' + 'div><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
