...
if (license_type) {
	...
	application.setValueListItems('PREF_license_type',new Array('Demo','Purchased'))
...
if (!license_type) {
	var dataset = application.getValueListItems('PREF_license_type')
	...
	if (realValue[0] != null) {
		...
		application.setValueListItems('PREF_license_type',displayValue,realValue)
	}
}
