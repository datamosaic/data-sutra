...
//error mode
	...
	forms.DATASUTRA_0F_solution__error.elements.tab_main.tabIndex = 5
}
...
if (application.__parent__.solutionPrefs && solutionPrefs.config && solutionPrefs.config.formNameBase) {
	...
	forms[baseForm].elements.tab_content_C.addTab(forms.PREF_0F_solution__reset_data,'')
	forms[baseForm].elements.tab_content_C.tabIndex = forms[baseForm].elements.tab_content_C.getMaxTabIndex()
}
//error mode
else {
	forms.DATASUTRA_0F_solution__error.elements.tab_main.tabIndex = 4
}
...
if (application.__parent__.solutionPrefs && solutionPrefs.config && solutionPrefs.config.formNameBase) {
	...
	forms[baseForm].elements.tab_content_C.addTab(forms.PREF_0F_error,'')
	forms[baseForm].elements.tab_content_C.tabIndex = forms[baseForm].elements.tab_content_C.getMaxTabIndex()
}
//error mode
else {
	forms.DATASUTRA_0F_solution__error.elements.tab_main.tabIndex = 1
}
...
if (application.__parent__.solutionPrefs && solutionPrefs.config && solutionPrefs.config.formNameBase) {
	...
	forms[baseForm].elements.tab_content_C.addTab(forms.PREF_0F_solution__import_export,'')
	forms[baseForm].elements.tab_content_C.tabIndex = forms[baseForm].elements.tab_content_C.getMaxTabIndex()
}
//error mode
else {
...
if (application.__parent__.solutionPrefs && solutionPrefs.config && solutionPrefs.config.formNameBase) {
	...
	forms[baseForm].elements.tab_content_C.addTab(forms.PREF_0F_solution__static_object,'')
	forms[baseForm].elements.tab_content_C.tabIndex = forms[baseForm].elements.tab_content_C.getMaxTabIndex()
}
//error mode
else {
	forms.DATASUTRA_0F_solution__error.elements.tab_main.tabIndex = 2
}
